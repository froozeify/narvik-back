...
abstract class AbstractEntityClubLinkedTestCase extends AbstractEntityTestCase {
  ...
  public function testGetCollectionAsSuperAdmin(): ResponseInterface {
    ...
    return $this->testGetCollectionWClubAs(UserRole::super_admin, InitStory::club_1(), $this->TOTAL_SUPER_ADMIN);
  }

  public function testGetCollectionAsAdminClub1(): ResponseInterface {
    $this->loggedAsAdminClub1();
    return $this->testGetCollectionWClubAs(ClubRole::admin, InitStory::club_1(), $this->TOTAL_ADMIN_CLUB_1);
  }

  public function testGetCollectionAsAdminClub2(): ResponseInterface {
    $this->loggedAsAdminClub2();
    return $this->testGetCollectionWClubAs(ClubRole::admin, InitStory::club_2(), $this->TOTAL_ADMIN_CLUB_2);
  }

  public function testGetCollectionAsSupervisorClub1(): ResponseInterface {
    $this->loggedAsSupervisorClub1();
    return $this->testGetCollectionWClubAs(ClubRole::supervisor, InitStory::club_1(),$this->TOTAL_SUPERVISOR_CLUB_1);
  }

  public function testGetCollectionAsMemberClub1(): ResponseInterface {
    $this->loggedAsMemberClub1();
    return $this->testGetCollectionWClubAs(ClubRole::member, InitStory::club_1(), $this->TOTAL_MEMBER_CLUB_1);
  }
}
